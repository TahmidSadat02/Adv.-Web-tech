...
export default function AdminDashboard() {
  ...
  const { token, userRole, loading, triggerNotification, menuItems, fetchMenu } = useContext(AppContext);
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {menuItems.length === 0 ? (
                <tr>
                  <td colSpan={6} className="py-6 px-4 text-center text-gray-500 font-medium">
